...
Using the Nick Gammon HardwareSerial9Bit mod for 9 bit serial communications (files available here : http://gammon.com.au/Arduino/HardwareSerial9bit.zip) and Xonik (http://Xonik.no) precious informations about the PG-200 protocol, this projet can mimic a PG-200.
